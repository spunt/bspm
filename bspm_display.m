...
uicontrol(fg,'Style','Frame','Position',[60 025 200 325].*WS,'DeleteFcn','spm_image(''reset'');');
uicontrol(fg,'Style','Text', 'Position',[75 210 100 020].*WS,'String','right  {mm}');
uicontrol(fg,'Style','Text', 'Position',[75 180 100 020].*WS,'String','forward  {mm}');
uicontrol(fg,'Style','Text', 'Position',[75 150 100 020].*WS,'String','up  {mm}');
uicontrol(fg,'Style','Text', 'Position',[75 120 100 020].*WS,'String','pitch  {rad}');
uicontrol(fg,'Style','Text', 'Position',[75 090 100 020].*WS,'String','roll  {rad}');
uicontrol(fg,'Style','Text', 'Position',[75 060 100 020].*WS,'String','yaw  {rad}');
...
uicontrol(fg,'Style','edit','Callback','spm_image(''repos'',1)','Position',[175 210 065 025].*WS,'String','0','ToolTipString','translate');
uicontrol(fg,'Style','edit','Callback','spm_image(''repos'',2)','Position',[175 180 065 025].*WS,'String','0','ToolTipString','translate');
uicontrol(fg,'Style','edit','Callback','spm_image(''repos'',3)','Position',[175 150 065 025].*WS,'String','0','ToolTipString','translate');
uicontrol(fg,'Style','edit','Callback','spm_image(''repos'',4)','Position',[175 120 065 025].*WS,'String','0','ToolTipString','rotate');
uicontrol(fg,'Style','edit','Callback','spm_image(''repos'',5)','Position',[175 090 065 025].*WS,'String','0','ToolTipString','rotate');
uicontrol(fg,'Style','edit','Callback','spm_image(''repos'',6)','Position',[175 060 065 025].*WS,'String','0','ToolTipString','rotate');
...
uicontrol(fg,'Style','PushButton', 'Position',[75 310 170 010].*WS,...
...
uicontrol(fg,'Style','Text', 'Position',[75 285 35 025].*WS,'String','mm:');
uicontrol(fg,'Style','Text', 'Position',[75 260 35 025].*WS,'String','vx:');
uicontrol(fg,'Style','Text', 'Position',[75 235 65 025].*WS,'String','Intensity:');

st.mp = uicontrol(fg,'Style','edit', 'Position',[110 285 135 025].*WS,'String','','Callback','spm_image(''setposmm'')','ToolTipString','move crosshairs to mm coordinates');
st.vp = uicontrol(fg,'Style','edit', 'Position',[110 260 135 025].*WS,'String','','Callback','spm_image(''setposvx'')','ToolTipString','move crosshairs to voxel coordinates');
st.in = uicontrol(fg,'Style','Text', 'Position',[140 235 085 025].*WS,'String','');
