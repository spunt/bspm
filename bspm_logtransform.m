function bspm_logtransform(in, prefix)
% BSPM_LOGTRANSFORM
% USAGE: bspm_logtransform(in)
%
%   ARGUMENTS
%       in:         cell array of images to transform
%       prefix:     prefix for output filename   (default = 'l')
%       
...
if nargin<2, prefix = 'l'; end
if nargin<1, error('USAGE: bspm_logtransform(in,rescale)'); end
