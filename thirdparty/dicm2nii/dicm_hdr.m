...
a = par_key('Examination date/time', 0);
...
a = par_key('Patient position', 0);
if isempty(a), a = par_key('Patient Position', 0); end
if ~isempty(a)
...
a = par_key('Preparation direction', 0); % Anterior-Posterior
if ~isempty(a)
    a = a(regexp(a, '\<.')); % 'AP'
