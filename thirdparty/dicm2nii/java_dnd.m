...
evt.ControlDown = jEvent.getDropAction()==1073741824; % ACTION_LINK
...
if jSource.getDropType() == 1 % String dropped
    ...
    if strncmp(evt.Data, 'file://', 7) % files identified as string
        ...
        evt.Data = strrep(evt.Data, 'file://', '');
        evt.Data = strsplit(evt.Data, char(10))';
        evt.Data(cellfun(@isempty, evt.Data)) = [];
    end
...
%% DragEnterCallback by MLDropTarget
...
%% DragExitCallback by MLDropTarget
