...
%--------------------------------------------------------------------------
if exist(fullfile(SPM.swd,'mask.nii'),'file') == 2
...
if isfield(xX,'W')
    ...
    Vbeta(1:nBeta) = deal(struct(...
        ...
        'descrip',  ''));
    for i = 1:nBeta
        Vbeta(i).fname   = sprintf('beta_%04d.nii',i);
    ...
    for i = 1:nSres
        VResI(i).fname   = sprintf('ResI_%04d.nii', i);
