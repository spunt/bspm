function opts = ipctb_spm_config_slice_timing
% configuration file for slice timing
%____________________________________________________________________
% Copyright (C) 2005 Wellcome Department of Imaging Neuroscience

% Darren Gitelman
% $Id: ipctb_spm_config_slice_timing.m 654 2006-10-17 17:17:27Z john $
...
for i = 1:length(job.scans)
    ...
    ipctb_spm_slice_timing(P,Seq,refslice,timing)
end
return;
% ---------------------------------------------------------------------
...
for i=1:numel(job.scans),
    ...
    [pth,nam,ext,num] = ipctb_spm_fileparts(job.scans{i}{j});
