function ipctb_spm_dcm_display(varargin)
...
% Karl Friston
% $Id: spm_dcm_display.m 112 2005-05-04 18:20:52Z john $
...
%---------------------------------------------------------------------------
try
	V = ipctb_spm_vol(fullfile(ipctb_spm('Dir'),'canonical','single_subj_T1.nii'));
catch
	V = ipctb_spm_vol('mask.img');
	figure(Fgraph)
end
ijk       = inv(V.mat)*xyz;
t1        = ipctb_spm_sample_vol(V,ijk(1,:),ijk(2,:),ijk(3,:),2);
