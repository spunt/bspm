function [mnv,mxv] = ipctb_spm_minmax(g)
...
% John Ashburner
% $Id: spm_minmax.m 570 2006-07-05 14:29:24Z john $


d   = [size(g) 1];
mxv = double(max(g(:)));
h   = zeros(256,1);
ipctb_spm_progress_bar('Init',d(3),'Initial histogram','Planes loaded');
for i=1:d(3)
    h = h + ipctb_spm_hist(uint8(round(g(:,:,i)*(255/mxv))),ones(d(1)*d(2),1));
