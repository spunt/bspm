function varargout = ipctb_spm_slice_vol(varargin)
% returns a slice through a memory mapped image - a compiled routine
% FORMAT X = ipctb_spm_slice_vol(V,A,dim,hold);
...
%
% ipctb_spm_slice_vol returns a section through a memory mapped image volume
...
% John Ashburner
% $Id: ipctb_spm_slice_vol.m 112 2005-05-04 18:20:52Z john $


%-This is merely the help file for the compiled routine
error('ipctb_spm_slice_vol.c not compiled - see Makefile')
