...
if isa(params, myclass)
  ...
  [p others] = ipctb_spm_mars_struct('split', others, defstruct);
  o = ipctb_spm_mars_struct('ffillmerge', o, p);
  return
end

% fill params with defaults, parse into fields for this object, children
params = ipctb_spm_mars_struct('fillafromb', params, others);
[params, others] = ipctb_spm_mars_struct('ffillsplit', defstruct, params);
