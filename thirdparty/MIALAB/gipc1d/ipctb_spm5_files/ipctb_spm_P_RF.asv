function [P,p,Em,En,EN] = ipctb_spm_P_RF(c,k,Z,df,STAT,R,n)
...
EC      = ipctb_spm_ECdensity(STAT,Z,df);
EC      = EC([1:D]) + eps;
...
%===========================================================================
P       = 1 - ipctb_spm_Pcdf(c - 1,(Em + eps)*p);
...
function [EC] = ipctb_spm_ECdensity(STAT,t,df)
