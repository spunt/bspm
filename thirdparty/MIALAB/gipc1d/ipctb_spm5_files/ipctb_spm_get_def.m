function def = ipctb_spm_get_def(Bx,By,Bz,beta)
...
% Jesper Andersson
% $Id: ipctb_spm_get_def.m 184 2005-05-31 13:23:32Z john $
...
elseif nargin == 3
   ...
   beta = Bz;
   Bx = ipctb_spm_dctmtx(nx,mx);
   By = ipctb_spm_dctmtx(ny,my);
   Bz = ipctb_spm_dctmtx(nz,mz);
end
