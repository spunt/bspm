function opts = ipctb_spm_config_realign_and_unwarp
% Configuration file for realign and unwarping jobs
%_______________________________________________________________________
% Copyright (C) 2005 Wellcome Department of Imaging Neuroscience

% Darren R. Gitelman
% $Id: ipctb_spm_config_realign_and_unwarp.m 663 2006-10-23 17:18:32Z john $
...
p5 = 'Otherwise enter a customized set of movements to model';
...
% put the expression in the context of the bse workspace.
...
for i = 1:numel(P)
    ...
    % unwarp estimate
    %----------------------------------------------------------------
    tmpP = ipctb_spm_vol(P{i}(1,:));
    uweflags.M = tmpP.mat;
    ds = ipctb_spm_uw_estimate(P{i},uweflags);
    ads(i) = ds;
...
%----------------------------------------------------------------
ipctb_spm_uw_apply(ads,uwrflags);
return;
...
if job.uwroptions.uwwhich(2),
    [pth,nam,ext,num] = ipctb_spm_fileparts(P{1});
