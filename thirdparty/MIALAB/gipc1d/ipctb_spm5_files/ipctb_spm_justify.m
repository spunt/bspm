function out = ipctb_spm_justify(varargin)
% ipctb_spm_justify Justifies a text string
%    OUT = ipctb_spm_justify(N,TXT) justifies text string TXT to
%    the length specified by N.
%
%    OUT = ipctb_spm_justify(OBJ,TXT) justifies text string to
...
%
%    Example:
%    out = ipctb_spm_justify(40,{['Statistical Parametric ',...
...
% John Ashburner
% $Id: ipctb_spm_justify.m 491 2006-03-31 17:36:45Z john $
...
if nargin < 2
    error('Incorrect usage of ipctb_spm_justify.')
end
n = varargin{1};
if ishandle(n)
