function [value] = ipctb_ica_questionDialog(varargin)
...
okH = ipctb_ica_uicontrol('parent', figHandle, 'units', 'normalized', 'style', 'pushbutton', 'string', okString, 'callback', ...
    @okCallback , 'position', okPos, 'tag', 'yes');

cancelH = ipctb_ica_uicontrol('parent', figHandle, 'units', 'normalized', 'style', 'pushbutton', 'string', cancelString, ...
