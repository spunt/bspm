function [popupHandle]=ipctb_ica_getUIPopUp(Handle,labels,pos,callback_function,visible,Tag)
% [popupHandle]=ipctb_ica_getUIPopUp(Handle,labels,pos,callback_function,visible,Tag);
%--------------------------------------------------------------------------
