function [previousDir] = ipctb_ica_showcwdHistory
...
try
    ...
    [fileContents] = ipctb_ica_listFiles_inDir(preferenecesDir, '*.m');
    ...
    if isempty(checkCwdHistory)
        ...
        if fid ~= -1
            ...
            [temp, nLines, nonSpace] = ipctb_ica_readContents_file(fid);
            fclose(fid);
        end
