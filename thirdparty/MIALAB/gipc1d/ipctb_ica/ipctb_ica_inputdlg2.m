function Answer = ipctb_ica_inputdlg2(Prompt, Title, NumLines, DefAns,Resize)
...
FigColor = BG_COLOR; % use from ipctb_ica_defaults
...
BtnFontSize = UI_FS; % get from ipctb_ica_defaults
