function figHandle = ipctb_ica_dialogBox(varargin)
...
if strcmp(textType, 'small')
    ...
    ipctb_ica_uicontrol('parent', figHandle, 'units', 'normalized', 'style', 'pushbutton', 'string', 'OK', 'callback', ...
...
elseif strcmp(textType, 'large')
    ...
    handle_scroll = ipctb_ica_uicontrol('parent', figHandle, 'units', 'normalized', 'style','listbox', ...
    ...
    if isempty(plot_figure)
        ipctb_ica_uicontrol('parent', figHandle, 'units', 'normalized', 'style', 'pushbutton', 'string', 'OK', ...
        ...
        ipctb_ica_uicontrol('parent', figHandle, 'units', 'normalized', 'style', 'pushbutton', 'string', 'OK', 'callback', cancelCallback, 'position', ...
            okPos, 'fontunits', UI_FONTUNITS, 'fontname', UI_FONTNAME, 'FontSize', UI_FS, 'ForegroundColor',BUTTON_FONT_COLOR, ...
            'backgroundcolor', BUTTON_COLOR);
        % plot button
        plotH = ipctb_ica_uicontrol('parent', figHandle, 'units', 'normalized', 'style', 'pushbutton', 'string', 'Plot', 'callback', {@plotCallback, figHandle} , 'position', ...
...
plotH = ipctb_ica_getGraphics('Parameter Options', 'other', 'figure');
