...
if (writeInfo)
    ...
    [tmps, freq] = icatb_get_spectra(randn(1, min(diffTimePoints)), TR, spectra_params);
    ...
    parfor countS = 1:sesInfo.numOfSub*sesInfo.numOfSess
        ...
        temp_spectra = icatb_get_spectra(timecourses', TR, spectra_params);
