...
text('units', 'normalized', 'string', 'GroupICAT v4.0a', 'position', titlePos, 'fontsize', subtitleFont, 'HorizontalAlignment', 'center', ...
...
% authors
giftInfo = {'', '', ['\bfRelease Date: \rm', num2str('02-May-2015')], '', str2mat('\bfAuthors: \rm\bfVince Calhoun, \rm\bfTom Eichele, \rm\bfEric Egolf &', '                \rm\bfSrinivas Rachakonda'), ...
