function T = lui_spm_type(x, arg)
% translates data type specifiers between lui_spm & Matlab representations
% FORMAT T = lui_spm_type(x, arg)
% x    - specifier
% T    - type
...
% $Id: lui_spm_type.m 112 2005-05-04 18:20:52Z john $
