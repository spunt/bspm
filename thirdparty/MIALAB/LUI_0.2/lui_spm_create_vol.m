function V = lui_spm_create_vol(V,varargin)
% Create a volume
% FORMAT V = lui_spm_create_vol(V)
% V - image volume information (see lui_spm_vol.m)
%____________________________________________________________________________
% Copyright (C) 2005 Wellcome Department of Imaging Neuroscience

% John Ashburner
% $Id: lui_spm_create_vol.m 1014 2007-11-29 14:53:20Z volkmar $
...
if ~isfield(V,'dt'),
    V.dt = [lui_spm_type('float64') lui_spm_platform('bigend')];
end;

dt{1} = lui_spm_type(V.dt(1));
