function V = lui_spm_vol_nifti(fname,n)
%  Get header information for a NIFTI-1 image.
%  FORMAT V = lui_spm_vol_nifti(P)
%  P - filename.
...
% John Ashburner
% $Id: lui_spm_vol_nifti.m 112 2005-05-04 18:20:52Z john $
...
off = (n(1)-1+dm(4)*(n(2)-1))*ceil(lui_spm_type(dt(1),'bits')*dm(1)*dm(2)/8)*dm(3) + N.dat.offset;
