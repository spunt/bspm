function V = lui_spm_write_plane(V,dat,n)
% Write transverse plane(s) of image data.
% FORMAT VO = lui_spm_write_plane(V,dat,n)
% V   - data structure containing image information.
%       - see lui_spm_vol for a description.
...
%       It is possible that future versions of lui_spm_write_plane may
...
% John Ashburner
% $Id: lui_spm_write_plane.m 800 2007-04-27 07:35:27Z volkmar $
