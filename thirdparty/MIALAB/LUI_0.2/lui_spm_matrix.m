function [A] = lui_spm_matrix(P)
% returns an affine transformation matrix
% FORMAT [A] = lui_spm_matrix(P)
% P(1)  - x translation
% P(2)  - y translation
% P(3)  - z translation
...
%
% lui_spm_matrix returns a matrix defining an orthogonal linear (translation,
...
% 4) translation
%
% lui_spm uses a PRE-multiplication format i.e. Y = A*X where X and Y are 4 x n
...
% Karl Friston
% $Id: lui_spm_matrix.m 112 2005-05-04 18:20:52Z john $
