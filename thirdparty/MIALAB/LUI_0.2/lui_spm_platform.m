function varargout=lui_spm_platform(varargin)
% Platform specific configuration parameters for lui_spm
%
% FORMAT ans = lui_spm_platform(arg)
...
%
% FORMAT PlatFontNames = lui_spm_platform('fonts')
...
%
% FORMAT PlatFontName = lui_spm_platform('font',GenFontName)
% Maps generic (UNIX) FontNames to platform specific FontNames
%
% FORMAT PLATFORM = lui_spm_platform('init',comp)
...
%-----------------------------------------------------------------------
%
% Since calls to lui_spm_platform will be made frequently, most platform
...
% Matthew Brett
% $Id: lui_spm_platform.m 983 2007-10-29 15:56:35Z john $
...
if isempty(ci), error([comp,' not supported architecture for lui_spm']), end
