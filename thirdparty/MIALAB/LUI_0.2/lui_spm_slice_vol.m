function varargout = lui_spm_slice_vol(varargin)
% returns a slice through a memory mapped image - a compiled routine
% FORMAT X = lui_spm_slice_vol(V,A,dim,hold);
...
%
% lui_spm_slice_vol returns a section through a memory mapped image volume
% on disk.  This section is the transverse slice at z = 0 after linear
% transformation according to matrix A
%
% see also lui_spm_sample_vol.m
%
%_______________________________________________________________________
% Copyright (C) 2005 Wellcome Department of Imaging Neuroscience

% John Ashburner
% $Id: lui_spm_slice_vol.m 112 2005-05-04 18:20:52Z john $


%-This is merely the help file for the compiled routine
error('lui_spm_slice_vol.c not compiled - see Makefile')
