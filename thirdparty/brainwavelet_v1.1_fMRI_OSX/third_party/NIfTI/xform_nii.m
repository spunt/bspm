...
%
function [nii,obQ] = xform_nii(nii, tolerance, preferredForm)
   ...
   [hdr,orient,obQ]=change_hdr(hdr,tolerance,preferredForm);
...
%-----------------------------------------------------------------------
function [hdr, orient, obQ] = change_hdr(hdr, tolerance, preferredForm)
   
   % Added AXP 27-03-2014
   obQ=0;
   orient = [1 2 3];
   affine_transform = 1;
