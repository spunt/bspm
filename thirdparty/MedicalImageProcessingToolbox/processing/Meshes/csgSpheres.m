function outMesh = csgSpheres(m1,m2,varargin)
% outMesh = csgSpheres(m1,m2)
%   
%   Computes different operations of constructive solid geometry between
%   two spheres: Union, difference and intersection
%
...
outMesh = treeSmall.generateOutputMesh(op);
