...
subjects_out = {
	'/m/nbe/scratch/braindata/shared/toolboxes/bramila/testdata/output/demo_week31_fc/010'
    '/m/nbe/scratch/braindata/shared/toolboxes/bramila/testdata/output/demo_week31_fc/026'
};
