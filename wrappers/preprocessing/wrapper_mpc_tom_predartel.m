...
saveit              = 1;
omitsubpat          = '';
append2jobname      = 'MPC_TOMONLY_PREDARTEL';
...
if ~isempty(omitsubpat), subdirs(cellstrfind(subdirs, omitsubpat)) = []; end

% | Omit Initial Volumes
if runit.omitvols
    omitvolspat = {'fadolphs*_00001.nii' 'fadolphs*_00002.nii'};
    bspm_omit_vols(fullfile(path.study, pattern.subdir, 'raw', pattern.epidir), omitvolspat);
end
