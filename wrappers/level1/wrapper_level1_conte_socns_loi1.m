function allinput = wrapper_level1_conte_socns_loi1(varargin)
% matlabbatch = wrapper_level1_conte_socns_loi1(varargin)
%
...
for s = 1:length(subdir)
    ...
    % | Cleanup Workspace
    % | ========================================================================
    clear general_info runs contrasts b images
...
b.condlabels = {'Nonsocial' 'Face' 'Hand' 'Scram'};
