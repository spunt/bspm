...
%
%   USAGE: disptable(M, col_strings, row_strings, fmt, spaces)
%
...
%   Author: Jo?o F. Henriques, April 2010
    ...
    if all([num_rows==num_cols isempty(col_strings)])
       col_strings = cellstr(num2str((1:num_cols)'));
       if size(row_strings, 1)==1, row_strings = row_strings'; end
       row_strings = strcat(col_strings, {': '}, row_strings); 
    end
