function [xmatrix, xname, sessidx] = bspm_get_unfiltered_design(spmmat, r_tag)
% BSPM_GET_UNFILTERED_DESIGN  Extract raw design matrix from SPM.mat
%
%   USAGE: [xmatrix xname sessidx] = bspm_get_unfiltered_design(spmmat, r_tag)
%
%   INPUTS:
