function [] = bspm_dartel_norm_anat(images, flowfields, template, voxsize)
...
if nargin<3
   disp('USAGE: bspm_dartel_norm_anat(images, flowfields, template, voxsize, fwhm)');
   return
elseif nargin<4
    voxsize = 1;
end
fwhm = 0;
if length(voxsize)==1
    voxsize = [voxsize voxsize voxsize];
end
